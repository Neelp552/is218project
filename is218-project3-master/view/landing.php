...
<div class="container h-100 justify-content-center">
    <form action="../index.php" name="question_table">
        <button class="btn btn-primary float-right" name="form_action" formmethod="post" formaction="../index.php" value="logout">Logout</button>
    <table id="questions" class="table">
        ...
        <button class="btn btn-primary mr-3" name="form_action" formmethod="post" formaction="../index.php" value="display_edit_question">Edit question</button>
        <button class="btn btn-primary mr-3" name="form_action" formmethod="post" formaction="../index.php" value="delete_question">Delete question</button>
        ...
        <button class="btn btn-primary mr-3" name="form_action" formmethod="post" formaction="../index.php" value="display_all_questions">Find all Questions</button>
    </form>
</div>
